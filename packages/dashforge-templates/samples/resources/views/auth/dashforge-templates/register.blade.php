            ...
            <div class="media align-items-stretch justify-content-center ht-100p">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter your lastname">
                        ...
                        <div class="tx-13 mg-t-20 tx-center">Already have an account? <a href="{{ url('/login') }}">Sign
                                In</a></div>
                    </div>
                    <!-- </div> -->
                </form><!-- sign-wrapper -->
                <div
                    class="media-body pd-y-30 pd-lg-x-50 pd-xl-x-60 align-items-center d-none d-lg-flex pos-relative bg-dark">
            ...
            <div class="pos-absolute b-0 r-0 tx-12">
              Social media marketing vector is created by <a href="https://www.freepik.com/pikisuperstar" target="_blank">pikisuperstar (freepik.com)</a>
                    ...
                    <div class="wd-250 wd-xl-450 mg-y-30 pd-x-30">
                        <div class="signin-logo tx-28 tx-bold tx-white"><span class="tx-normal">[</span> Webcore <span
                                class="tx-info">2020</span> <span class="tx-normal">]</span></div>
                        <div class="tx-white mg-b-60">Integrated Web Backend Generator</div>

                        <h5 class="tx-white">Why Webcore 2020?</h5>
                        <p class="tx-white-6">Support templeting, swagger api documentation and file manager.</p>
                        <p class="tx-white-6 mg-b-60">Generate all CRUD logic and UI (datagrid) with additional related
                            dropdown or form. Ready to be build as per your need of web backend project.</p>
                        <a href="https://dandisy.github.io"
                            class="btn btn-outline-light bd bd-white bd-2 tx-white pd-x-25 tx-uppercase tx-12 tx-spacing-2 tx-medium">Get
                            In Touch</a>
                    </div>
                </div><!-- media-body -->
            </div><!-- media -->
