...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('birth_date', null, ['class' => 'form-control date']) !!}
</div>
...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('address', null, ['class' => 'form-control my-editor']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('prospectiveStudents.index') !!}" class="btn btn-light">Cancel</a>
</div>
