...
<div class="px-3">
    @foreach ($permissions as $permission)
        <div class="d-flex justify-content-between align-items-center bg-secondary rounded pl-3 py-2 mb-2 text-white">
            ...
            <button class="btn text-white btn-hide" type="button">Hide <i
                    class="icon ion-md-arrow-up mg-l-5"></i></button>
        </div>
        <div class="mb-3">
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('staff_tus.index') !!}" class="btn btn-light">Cancel</a>
</div>
    ...
    <script>
        ...
        $(document).ready(() => {
            ...
            $.each(categories, (i, category) => {
                ...
                if (input_permission.length === [...input_permission].filter((input) => input.checked ===
                        true).length) {
        ...
        $(document).on('change', '.check-permission', (e) => {
            ...
            if (input_permission.length === [...input_permission].filter((input) => input.checked === true)
                .length) {
